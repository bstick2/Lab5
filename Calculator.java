...
public class Calculator
{
    ...
    {
    	int num1 = Integer.parseInt(tokens[0]); // Throws NumberFormatException if the first token is not an int value.
    	int num2 = Integer.parseInt(tokens[2]); // Throws NumberFormatException if the third token is not an int value.
    		...
    		
    {
    	...
    	try {
    		return String.format( "The result is: %d", execute(arr));
		} 
